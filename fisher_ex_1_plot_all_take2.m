...
%             subplot(10,10,60*(count-1)+[1:5 11:15 21:25])
...
subplot(2,1,1)
                ...
                hold on
                title(['Example 1, u(t = '  num2str(round(t(i))) ',x,m)'],'fontsize',35)
...
%                 set(gca,'ytick',[])
                set(gca,'xtick',[])
                text(-1,1.15,['(' char(96+count) ')'],'fontsize',35)
...
%             subplot(18,10,60*(count-1)+[31:35 41:45])
        ...
        export_fig(fig_final,['ex_1_full' num2str(count) '.eps'])
        saveas(fig_final,['ex_1_full' num2str(count) '.fig'])
